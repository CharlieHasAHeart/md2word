...
def convert_markdown_to_docx(
    ...
    if template_path is None:
        ...
        render_markdown_to_document(doc, body_markdown, source, anchor=anchor, body_style_name=_resolve_body_style_name(doc))
...
def _inject_template_placeholder(doc: Document, token: str, value: str, style_names: tuple[str, ...]) -> None:
    if not value:
        return
